...
////////----Questions----//////////////////////
/*
 * -Had trouble with 'commit *' because of 
 *  NPM module being ignored
 *  gave this error:
 *    
 * 
*/
...
*/
let it = [{make: 'Ford', model: 'explorer'}]
...
function getGermanCars(arr) {
  ...
  function isGerman(car){
    for(let i = 0; i < germanCars.length; i++){
      if(germanCars[i] === car.car_make){
        return true;
      }      
    }
    return false;
